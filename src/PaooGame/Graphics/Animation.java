...
public class Animation {
    ...
    private int speed;
    /*!< Viteza animatiei (milisecunde pe cadru).*/
    private int index;
    /*!< Indexul curent al cadrului animatiei.*/
    private long lastTime;
    /*!< Timpul la ultima actualizare a animatiei.*/
    private long timer;
    /*!< Contor pentru timpul trecut intre cadre.*/
    public BufferedImage[] frames;
    /*!< Tablou cu toate cadrele animatiei.*/
