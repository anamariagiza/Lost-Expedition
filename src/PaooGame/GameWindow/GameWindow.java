...
public class GameWindow
{
    ...
    // Adaugate pentru a stoca dimensiunile si pozitia ferestrei inainte de fullscreen
    ...
    public void BuildGameWindow()
    {
        ...
        wndFrame.setResizable(true); // Permitem redimensionarea pentru fullscreen
        ...
        /// adaugat in fereastra trebuie apelata metoda add a obiectului wndFrame
        wndFrame.add(canvas);
        /// Urmatorul apel de functie are ca scop eventuala redimensionare a ferestrei
        /// ca tot ce contine sa poate fi afisat complet
        wndFrame.pack();

        // Salveaza dimensiunile originale ale ferestrei la initializare
    ...
    public void setFullScreen(boolean fullScreen) {
        ...
        if (gd.isFullScreenSupported()) {
            if (fullScreen) {
                originalBounds = wndFrame.getBounds(); // Salveaza dimensiunile curente
                wndFrame.dispose(); // Elibereaza resursele ferestrei
                wndFrame.setUndecorated(true); // Fara bara de titlu/margini
                gd.setFullScreenWindow(wndFrame); // Seteaza fullscreen
                wndFrame.setVisible(true); // Re-afiseaza fereastra
            } else {
                wndFrame.dispose(); // Elibereaza resursele ferestrei
                wndFrame.setUndecorated(false); // Cu bara de titlu/margini
                gd.setFullScreenWindow(null); // Iesire din fullscreen
                wndFrame.setBounds(originalBounds); // Restaureaza dimensiunile originale
                wndFrame.setVisible(true); // Re-afiseaza fereastra
            }
            // Actualizeaza dimensiunile canvas-ului la noile dimensiuni ale ferestrei
