...
/*!
 * \class public class DatabaseManager
 * \brief Gestioneaza conexiunea la baza de date SQLite si operatiunile de baza.
 * Se asigura de crearea tabelelor 'game_save' si 'game_settings' si ofera metode
 * pentru salvarea/incarcarea datelor de joc si a setarilor.
 */
public class DatabaseManager {
    ...
    /*!
     * \fn public DatabaseManager()
     * \brief Constructorul clasei DatabaseManager.
     * Initializeaza calea bazei de date si incearca sa se conecteze.
     */
    ...
    /*!
     * \fn private void initializeDatabasePath()
     * \brief Determina calea absoluta pentru fisierul bazei de date.
     * Fisierul bazei de date este stocat intr-un sub-director in directorul "user.home".
     */
    ...
    /*!
     * \fn public Connection connect()
     * \brief Stabileste o conexiune la baza de date SQLite.
     * \return Obiectul Connection, ou null in caz de eroare.
     */
     ...
     * \brief Creeaza tabelele necesare in baza de date daca nu exista deja.
     * Vom avea doua tabele: 'game_save' si 'game_settings' pentru setari.
     */
    ...
    /*!
     * \class public static class SaveGameData
     * \brief Clasa ajutatoare pentru a stoca datele incarcate dintr-un fisier de salvare.
     * Include acum starea ambelor chei si numarul de puzzle-uri rezolvate.
     */
    ...
    /*!
     * \fn public SaveGameData loadGameData()
     * \brief Incarca progresul jocului din tabela 'game_save'.
     * Include acum starea ambelor chei si numarul de puzzle-uri rezolvate.
    ...
    /*!
     * \fn public void saveSettingsData(boolean soundEnabled, boolean musicEnabled, int volume)
     * \brief Salveaza setarile jocului in tabela 'game_settings'.
     * Inseram ou actualizam o singura inregistrare (cu id=1).
     * \param soundEnabled Starea sunetului.
     * \param musicEnabled Starea muzicii.
     * \param volume Volumul.
     */
    ...
    /*!
     * \class public static class SettingsData
     * \brief Clasa ajutatoare pentru a stoca datele incarcate din setari.
     * Se foloseste ca Data Transfer Object (DTO).
     */
    ...
    /*!
     * \fn public boolean hasGameSave()
     * \brief Verifica daca exista o inregistrare de salvare in baza de date.
     * \return True daca exista o inregistrare in 'game_save' cu id=1, false altfel.
     */
